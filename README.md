...
![CI/CD Pipeline](https://github.com/mack3nzie-ai/devops-project/actions/workflows/main.yml/badge.svg)
...
### Langkah Commit & Push README:

*(Sesuaikan nama workflow `.yml` di baris badge paling atas jika file workflow GitHub Actions kamu bukan bernama `main.yml`).*

Jalankan ini di terminal:

```bash
git add README.md
git commit -m "docs: add comprehensive DevSecOps README with architecture and badges"
git push